...
typedef enum tuuvm_tuple_immediate_trivial_index_e
{
    ...
    TUUVM_TUPLE_IMMEDIATE_TRIVIAL_INDEX_PENDING_MEMOIZATION_VALUE,
...
#define TUUVM_PENDING_MEMOIZATION_VALUE TUUVM_TUPLE_MAKE_IMMEDIATE_TRIVIAL_WITH_INDEX(TUUVM_TUPLE_IMMEDIATE_TRIVIAL_INDEX_PENDING_MEMOIZATION_VALUE)
