 ...
 */
static inline tuuvm_tuple_t *tuuvm_tuple_getType(tuuvm_tuple_t *tuple)
{
    return (tuuvm_tuple_t*)(tuple->header.typePointerAndFlags & TUUVM_TUPLE_TYPE_POINTER_MASK);
}
