...
typedef enum sysbvm_typeFlags_e
{
    ...
    SYSBVM_TYPE_FLAGS_TEMPORARY_REFERENCE_VALUE = 1<<9,

    SYSBVM_TYPE_FLAGS_FUNCTION = 1<<10,
    ...
    SYSBVM_TYPE_FLAGS_TEMPORARY_REFERENCE_TYPE_FLAGS = SYSBVM_TYPE_FLAGS_FINAL | SYSBVM_TYPE_FLAGS_TEMPORARY_REFERENCE_VALUE,
