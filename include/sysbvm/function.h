...
typedef enum sysbvm_functionFlags_e
{
    ...
    SYSBVM_FUNCTION_FLAGS_GETTER_FLAGS = SYSBVM_FUNCTION_FLAGS_PURE | SYSBVM_FUNCTION_FLAGS_FINAL,
    SYSBVM_FUNCTION_FLAGS_SETTER_FLAGS = SYSBVM_FUNCTION_FLAGS_FINAL,
