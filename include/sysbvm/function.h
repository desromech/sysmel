...
typedef enum sysbvm_functionFlags_e
{
    ...
    SYSBVM_FUNCTION_FLAGS_TARGET_DEFINED_PRIMITIVE = 1<<19,

    SYSBVM_FUNCTION_FLAGS_WITHOUT_SOURCE_DEBUGGING = 1<<20,

    SYSBVM_FUNCTION_FLAGS_NOGC = 1<<21,
    SYSBVM_FUNCTION_FLAGS_NOESCAPE = 1<<22,
    ...
    SYSBVM_FUNCTION_FLAGS_BOOTSTRAP_PRIMITIVE_KEPT_FLAGS = SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_FUNCTION_FLAGS_PURE | SYSBVM_FUNCTION_FLAGS_FINAL | SYSBVM_FUNCTION_FLAGS_TARGET_DEFINED_PRIMITIVE,
