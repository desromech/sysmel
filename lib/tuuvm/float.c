...
{
    // Float32
    tuuvm_type_setPrintStringFunction(context, context->roots.float32Type, tuuvm_function_createPrimitive(context, 1, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float32_primitive_printString));

    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float32::fromFloat64", context->roots.float64Type, "f32", 1, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float32_primitive_fromFloat64);

    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float32::+", context->roots.float32Type, "+", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float32_primitive_add);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float32::-", context->roots.float32Type, "-", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float32_primitive_subtract);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float32::negated", context->roots.float32Type, "negated", 1, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float32_primitive_negate);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float32::sqrt", context->roots.float32Type, "sqrt", 1, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float32_primitive_sqrt);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float32::*", context->roots.float32Type, "*", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float32_primitive_multiply);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float32::/", context->roots.float32Type, "/", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float32_primitive_divide);

    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float32::<=>", context->roots.float32Type, "<=>", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float32_primitive_compare);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float32::=", context->roots.float32Type, "=", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float32_primitive_equals);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float32::~=", context->roots.float32Type, "~=", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float32_primitive_notEquals);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float32::<", context->roots.float32Type, "<", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float32_primitive_lessThan);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float32::<=", context->roots.float32Type, "<=", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float32_primitive_lessEquals);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float32::>", context->roots.float32Type, ">", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float32_primitive_greaterThan);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float32::>=", context->roots.float32Type, ">=", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float32_primitive_greaterEquals);

    // Float64
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float32::fromFloat32", context->roots.float32Type, "f64", 1, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float64_primitive_fromFloat32);

    tuuvm_type_setPrintStringFunction(context, context->roots.float64Type, tuuvm_function_createPrimitive(context, 1, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float64_primitive_printString));
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float64::+", context->roots.float64Type, "+", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float64_primitive_add);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float64::-", context->roots.float64Type, "-", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float64_primitive_subtract);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float64::negated", context->roots.float64Type, "negated", 1, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float64_primitive_negate);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float64::sqrt", context->roots.float64Type, "sqrt", 1, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float64_primitive_sqrt);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float64::*", context->roots.float64Type, "*", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float64_primitive_multiply);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float64::/", context->roots.float64Type, "/", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float64_primitive_divide);

    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float64::<=>", context->roots.float64Type, "<=>", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float64_primitive_compare);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float64::=", context->roots.float64Type, "=", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float64_primitive_equals);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float64::~=", context->roots.float64Type, "~=", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float64_primitive_notEquals);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float64::<", context->roots.float64Type, "<", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float64_primitive_lessThan);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float64::<=", context->roots.float64Type, "<=", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float64_primitive_lessEquals);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float64::>", context->roots.float64Type, ">", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float64_primitive_greaterThan);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Float64::>=", context->roots.float64Type, ">=", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_float64_primitive_greaterEquals);
}
