...
void tuuvm_integer_setupPrimitives(tuuvm_context_t *context)
{
    ...
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Integer::+", context->roots.integerType, "+", 2, TUUVM_FUNCTION_FLAGS_NONE, NULL, tuuvm_integer_primitive_add);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Integer::-", context->roots.integerType, "-", 2, TUUVM_FUNCTION_FLAGS_NONE, NULL, tuuvm_integer_primitive_subtract);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Integer::negated", context->roots.integerType, "negated", 1, TUUVM_FUNCTION_FLAGS_NONE, NULL, tuuvm_integer_primitive_negate);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Integer::*", context->roots.integerType, "*", 2, TUUVM_FUNCTION_FLAGS_NONE, NULL, tuuvm_integer_primitive_multiply);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Integer::/", context->roots.integerType, "/", 2, TUUVM_FUNCTION_FLAGS_NONE, NULL, tuuvm_integer_primitive_divide);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Integer::%", context->roots.integerType, "%", 2, TUUVM_FUNCTION_FLAGS_NONE, NULL, tuuvm_integer_primitive_remainder);

    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Integer::<=>", context->roots.integerType, "<=>", 2, TUUVM_FUNCTION_FLAGS_NONE, NULL, tuuvm_integer_primitive_compare);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Integer::=", context->roots.integerType, "=", 2, TUUVM_FUNCTION_FLAGS_NONE, NULL, tuuvm_integer_primitive_equals);
