...
{
    tuuvm_context_setIntrinsicSymbolBindingValueWithPrimitiveFunction(context, "FileSystem::workingDirectory", 0, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_filesystem_primitive_getWorkingDirectory);
    tuuvm_context_setIntrinsicSymbolBindingValueWithPrimitiveFunction(context, "FileSystem::workingDirectory:", 1, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_filesystem_primitive_setWorkingDirectory);
 
    tuuvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "FileSystem::absolute", context->roots.stringType, "FileSystem::absolute", 1, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE | TUUVM_FUNCTION_FLAGS_PURE | TUUVM_FUNCTION_FLAGS_FINAL, NULL, tuuvm_filesystem_primitive_absolute);
    tuuvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "FileSystem::isAbsolute", context->roots.stringType, "FileSystem::isAbsolute", 1, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE | TUUVM_FUNCTION_FLAGS_PURE | TUUVM_FUNCTION_FLAGS_FINAL, NULL, tuuvm_filesystem_primitive_isAbsolute);
    tuuvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "FileSystem::dirname", context->roots.stringType, "FileSystem::dirname", 1, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE | TUUVM_FUNCTION_FLAGS_PURE | TUUVM_FUNCTION_FLAGS_FINAL, NULL, tuuvm_filesystem_primitive_dirname);
    tuuvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "FileSystem::basename", context->roots.stringType, "FileSystem::basename", 1, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE | TUUVM_FUNCTION_FLAGS_PURE | TUUVM_FUNCTION_FLAGS_FINAL, NULL, tuuvm_filesystem_primitive_basename);
    tuuvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "FileSystem::extension", context->roots.stringType, "FileSystem::extension", 1, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE | TUUVM_FUNCTION_FLAGS_PURE | TUUVM_FUNCTION_FLAGS_FINAL, NULL, tuuvm_filesystem_primitive_extension);
    tuuvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "FileSystem::joinPath:", context->roots.stringType, "FileSystem::joinPath:", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE | TUUVM_FUNCTION_FLAGS_PURE | TUUVM_FUNCTION_FLAGS_FINAL, NULL, tuuvm_filesystem_primitive_joinPath);
}
