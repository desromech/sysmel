...
void tuuvm_boolean_setupPrimitives(tuuvm_context_t *context)
{
    ...
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveMethod(context, "Boolean::xor:", context->roots.booleanType, "xor:",2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_boolean_primitive_xor);
}
