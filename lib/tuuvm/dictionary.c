...
void tuuvm_dictionary_setupPrimitives(tuuvm_context_t *context)
{
    ...
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveFunction(context, "Dictionary::atOrNil:", 2, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_methodDictionary_primitive_atOrNil);
    tuuvm_context_setIntrinsicSymbolBindingWithPrimitiveFunction(context, "Dictionary::at:put:", 3, TUUVM_FUNCTION_FLAGS_CORE_PRIMITIVE, NULL, tuuvm_methodDictionary_primitive_atPut);
}
