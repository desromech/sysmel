...
void sysbvm_filesystem_setupPrimitives(sysbvm_context_t *context)
{
    ...
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "FileSystem::absolute", context->roots.stringType, "FileSystem::absolute", 1, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_FUNCTION_FLAGS_PURE | SYSBVM_FUNCTION_FLAGS_FINAL, NULL, sysbvm_filesystem_primitive_absolute);
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "FileSystem::isAbsolute", context->roots.stringType, "FileSystem::isAbsolute", 1, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_FUNCTION_FLAGS_PURE | SYSBVM_FUNCTION_FLAGS_FINAL, NULL, sysbvm_filesystem_primitive_isAbsolute);
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "FileSystem::dirname", context->roots.stringType, "FileSystem::dirname", 1, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_FUNCTION_FLAGS_PURE | SYSBVM_FUNCTION_FLAGS_FINAL, NULL, sysbvm_filesystem_primitive_dirname);
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "FileSystem::basename", context->roots.stringType, "FileSystem::basename", 1, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_FUNCTION_FLAGS_PURE | SYSBVM_FUNCTION_FLAGS_FINAL, NULL, sysbvm_filesystem_primitive_basename);
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "FileSystem::extension", context->roots.stringType, "FileSystem::extension", 1, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_FUNCTION_FLAGS_PURE | SYSBVM_FUNCTION_FLAGS_FINAL, NULL, sysbvm_filesystem_primitive_extension);
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "FileSystem::joinPath:", context->roots.stringType, "FileSystem::joinPath:", 2, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_FUNCTION_FLAGS_PURE | SYSBVM_FUNCTION_FLAGS_FINAL, NULL, sysbvm_filesystem_primitive_joinPath);
}
