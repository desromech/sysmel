...
{
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "Dictionary::add:", context->roots.dictionaryType, "add:", 2, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_FUNCTION_FLAGS_VIRTUAL, NULL, sysbvm_dictionary_primitive_add);
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "Dictionary::atOrNil:", context->roots.dictionaryType, "atOrNil:", 2, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_FUNCTION_FLAGS_VIRTUAL, NULL, sysbvm_dictionary_primitive_atOrNil);
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "Dictionary::at:put:", context->roots.dictionaryType, "at:put:", 3, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_FUNCTION_FLAGS_VIRTUAL, NULL, sysbvm_dictionary_primitive_atPut);
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "Dictionary::at:", context->roots.dictionaryType, "at:", 2, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_FUNCTION_FLAGS_VIRTUAL, NULL, sysbvm_dictionary_primitive_at);
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "Dictionary::scanFor:", context->roots.dictionaryType, "scanFor:", 2, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_FUNCTION_FLAGS_VIRTUAL , NULL, sysbvm_dictionary_primitive_scanFor);

    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "IdentityDictionary::add:", context->roots.identityDictionaryType, "add:", 2, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_FUNCTION_FLAGS_OVERRIDE, NULL, sysbvm_identityDictionary_primitive_add);
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "IdentityDictionary::associationAtOrNil:", context->roots.identityDictionaryType, "associationAtOrNil:", 2, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_FUNCTION_FLAGS_OVERRIDE, NULL, sysbvm_identityDictionary_primitive_associationAtOrNil);
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "IdentityDictionary::atOrNil:", context->roots.identityDictionaryType, "atOrNil:", 2, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_FUNCTION_FLAGS_OVERRIDE, NULL, sysbvm_identityDictionary_primitive_atOrNil);
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "IdentityDictionary::at:put:", context->roots.identityDictionaryType, "at:put:", 3, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_FUNCTION_FLAGS_OVERRIDE, NULL, sysbvm_identityDictionary_primitive_atPut);
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "IdentityDictionary::at:", context->roots.identityDictionaryType, "at:", 2, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_FUNCTION_FLAGS_OVERRIDE, NULL, sysbvm_identityDictionary_primitive_at);
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "IdentityDictionary::scanFor:", context->roots.identityDictionaryType, "scanFor:", 2, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_FUNCTION_FLAGS_OVERRIDE, NULL, sysbvm_identityDictionary_primitive_scanFor);

    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "WeakValueDictionary::atOrNil:", context->roots.weakValueDictionaryType, "atOrNil:", 2, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_FUNCTION_FLAGS_OVERRIDE, NULL, sysbvm_weakValueDictionary_primitive_atOrNil);
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "WeakValueDictionary::at:put:", context->roots.weakValueDictionaryType, "at:put:", 3, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_FUNCTION_FLAGS_OVERRIDE, NULL, sysbvm_weakValueDictionary_primitive_atPut);
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "WeakValueDictionary::at:", context->roots.weakValueDictionaryType, "at:", 2, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_FUNCTION_FLAGS_OVERRIDE, NULL, sysbvm_weakValueDictionary_primitive_at);
    ...
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "MethodDictionary::atOrNil:", context->roots.methodDictionaryType, "atOrNil:", 2, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_TYPE_FLAGS_FINAL | SYSBVM_FUNCTION_FLAGS_OVERRIDE, NULL, sysbvm_methodDictionary_primitive_atOrNil);
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "MethodDictionary::at:", context->roots.methodDictionaryType, "at:", 2, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_TYPE_FLAGS_FINAL | SYSBVM_FUNCTION_FLAGS_OVERRIDE, NULL, sysbvm_methodDictionary_primitive_at);
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "MethodDictionary::at:put:", context->roots.methodDictionaryType, "at:put:", 3, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_TYPE_FLAGS_FINAL | SYSBVM_FUNCTION_FLAGS_OVERRIDE, NULL, sysbvm_methodDictionary_primitive_atPut);
    sysbvm_context_setIntrinsicSymbolBindingValueWithPrimitiveMethod(context, "MethodDictionary::scanFor:", context->roots.methodDictionaryType, "scanFor:", 2, SYSBVM_FUNCTION_FLAGS_CORE_PRIMITIVE | SYSBVM_TYPE_FLAGS_FINAL | SYSBVM_FUNCTION_FLAGS_OVERRIDE, NULL, sysbvm_methodDictionary_primitive_scanFor);
}
